...
import { logbook, TYPES, BANDS } from "../../lib/logbook.js";
  ...
  root.innerHTML = `
    <section class="logbook lb-history">
      ...
      <div class="lb-cal-wrap">
        ...
        <button class="lb-cal-info" id="lb-cal-info" aria-label="how days are coloured" title="how days are coloured">${icon("info")}</button>
      </div>
      ${sel ? `
...
function openLegend() {
  return openSheet({
    title: "how days are coloured",
    cls: "lb-legend-wrap",
    html: `
      <p class="lb-acct-copy">Each day is coloured by how long you practised — never by whether it beat the day before.</p>
      <ul class="lb-legend">

...
const TITLES = { start: "What are you working on?", switch: "Switch to…", addtime: "Add time to…", take: "What is this a take of?", score: "Which goal is this the score of?", mark: "Which goal starts at this bookmark?" };
const QUICK_MINUTES = [15, 30, 45, 60];

/**
 * @param {{ mode?: "start"|"switch"|"addtime"|"take"|"score"|"mark", excludeId?: string|null }} opts

...
export function buildUI(root) {
  ...
  function renderToday() {
    ...
    const runPlace = run ? logbook.placeForGoal(run.goal.id) : null, runScore = runPlace?.score ?? null; // WSHED-98: the score of the running goal (at its bookmark, WSHED-108)
